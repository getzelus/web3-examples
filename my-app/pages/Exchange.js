      ...
      return (
        <div>
          <div className={styles.description}>
            ...
            {utils.formatEther(cdBalance)} Crypto Getz Tokens
            <br />
            {utils.formatEther(ethBalance)} Ether
            <br />
            {utils.formatEther(lpBalance)} Crypto Getz LP tokens
          </div>
          <div>
            ...
            {utils.parseEther(reservedCD.toString()).eq(zero) ? (
              <div>
                ...
                <input
                  type="number"
                  placeholder="Amount of CryptoGetz tokens"
                  onChange={(e) =>
                    setAddCDTokens(
      ...
      return (
        <div>
          ...
          >
            ...
            <option value="cryptoDevToken">Crypto Getz Token</option>
          </select>
          <br />
          <div className={styles.inputDiv}>
            {/* Convert the BigNumber to string using the formatEther function from ethers.js */}
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Crypto Getz Exchange!</h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Crypto Getz Tokens
          </div>
          <div>
            <button
        ...
        <div>
          <img className={styles.image} src="./cryptogetz/0.svg" />
        </div>
      </div>
